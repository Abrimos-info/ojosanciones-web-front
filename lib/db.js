...
async function queryItem(type,id,country,relations,keyword) {
    ...
    // console.log("result.hits.hits[0]._source.sanciones",result.hits.hits[0]._source.sanciones);
...
async function queryStats() {
    ...
    const stats = {
        ...
        last_update: result.aggregations.last_update?.value || null,
    }
    // console.log("queryStats last_update",stats.last_update);
    return stats;
}
